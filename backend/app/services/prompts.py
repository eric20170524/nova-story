class Prompts:
    ...
    def generate_timeline(content: str, character_profiles: str = "") -> str:
        ...
        return (
            ...
            "Return a JSON object with a key 'shots' containing a list of objects with the following fields:\n"
            "- 'id': sequential number\n"
            "- 'shot_type': Choose one [Extreme Long Shot, Long Shot, Medium Shot, Close-up, Extreme Close-up]\n"
            "- 'camera_movement': Choose one [Static, Pan, Tilt, Zoom In, Zoom Out, Tracking, Handheld]\n"
            "- 'camera_angle': Choose one [Eye-level, Low Angle, High Angle, Overhead, Dutch Angle]\n"
            "- 'visual_prompt': A highly detailed English description for image generation (Stable Diffusion style). "
            ...
            "- 'duration': Estimated duration in seconds (usually 3-5s for action, 5-10s for dialogue).\n"
            "\n"
            f"Story Text:\n{content}"
        )
